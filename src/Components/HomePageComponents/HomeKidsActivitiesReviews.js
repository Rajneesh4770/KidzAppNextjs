...
function HomeKidsActivitiesReviews() {
  ...
  const getReviewData = () => {
    axios
      .get(baseUrl + "reviews/featured?page=1&page_size=9&country_code=ae")
      .then((response) => {
    ...
    <div className={style.body}>
      ...
      <center>
        <h1 className={style.heading}>
          {getResponseMessage(constants).kids_act_reviews_by_parents}
        </h1>
                  ...
                  >
                    ...
                    >
                      <div className={style.cardbody}>
                        ...
                        />
                        <p className={style.cardTopPara}>
                          <b> {slide.venue.title} </b>
                        </p>
                        ...
                        <div className={style.bottomCardText}>
                          <div className={`d-flex ${style.bottomRow}`}>
                            ...
                            <div className=" col-6">
                              <div
                                className={`${style.starRate} ${style.rightText} ${style.textright}  absolute-center`}
                              >
                                <img
                                  ...
                                  alt=""
                                />
                                <span className={style.spanrating}>
                                  {slide.rating}.0
                                </span>
                              </div>
                            </div>
