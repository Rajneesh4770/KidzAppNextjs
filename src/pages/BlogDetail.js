          ...
          <div className={`my-4 ${style.mainText}`}>
            ...
            <div className="row mt-4">
              <div className={`col-md-8 d-flex ${style.leftContent}`}>
                ...
                <h6>
                  <i className="fa-solid fa-user"></i> Posted by: {x.auther_name}
                </h6>
                <h6>
...
export async function getStaticProps (){
  let res = await axios.get(baseUrl+'blogs?slug=13-play-venues-for-a-fun-filled-play-date');
  let props = {
