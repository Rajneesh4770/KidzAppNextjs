  ...
  return (
    ...
    <section className={style.section1}>
        <div className='container'>
            <div className='row'>
                <center><h1 className="p-3 ">Kidzapp Reviews - Read Customer Unbiased Reviews</h1></center>
                ...
                <div className={style.firstcard}>
                    ...
                    <div className='row d-flex'>
                      ...
                      <div className='col-8'>
                        <button className='btn btn-success float-end '>See All the Reviews of Commission Percentage Test-1</button>
                ...
                <div className={style.secondcard}>
                  ...
                  <div className='pb-4'>
                  <span><b>  <StarIcon style={{color:'#00adee'}}/> &nbsp;5 Love it</b></span> 
                     &nbsp; &nbsp; <span><b>  <BiTime style={{color:'#00adee'}}/> &nbsp;7 months ago</b></span> </div>
                  ...
                  <div className='row d-flex'>
                      ...
                      <div className='col-8'>
                        <button className='btn btn-success float-end '>See All the Reviews of Test qc-copy</button>
