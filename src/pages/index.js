  ...
  return (
    <div className={style.body}>
      <div className={`container ${style.sidenav}`}>
        <a
          href="https://api.whatsapp.com/send?phone=971566578854&text=Hi%2C+I%27m+browsing+home+screen+and+have+some+questions"
          className={`fixed ${style.a}`}
        >
          Chat
        </a>
      </div>
...
//     "https://api2.kidzapp.com/api/3.0/experiences/curated-list/?list_name=featured_banner_uae&country_code=ae&page=1&page_size=10&city=&website=1&lang=ar"
//   );
//   let props = {
