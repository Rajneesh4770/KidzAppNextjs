      ...
      <section>
        <div className={style.awardPartner}>
          <div className={`container ${style.awardPartnerContainer}`}>
            <div className={`row justify-content-center ${style.awardPartnerRow}`}>
      ...
      <section>
        <div className={style.awardWinners}>
          <div className={`container ${style.awardWinnersContainer}`}>
            <h3>Award Winners</h3>
            <div className={`row justify-content-center ${style.winnersMainWrapper} ${style.awardWinnersRow}`}>
              <div className={`col-md-12 p-0 ${style.awardWinnersCol}`}>
                <div className={style.winnersOuterSection}>
                  <div className={style.categoryBadgeSection}>
                    <img src='https://drfsb8fjssbd3.cloudfront.net/images/Younger_kids.png' alt='Awards Category' className={style.winnerSectionImg} />
                    <h2 className={style.categoryTitle}>Best for Younger Kids</h2>
                  </div>
                  <div className={style.winnerSection}>
                    <div className={`${style.winnerSectionInner} ${style.goldBlock}`}>
                      <div className={style.leftBlock}>
                        <img src='https://drfsb8fjssbd3.cloudfront.net/images/gold-winner.png' alt='Gold Winner' className={style.winnerSectionImg} />
                        <p>
                          Fun Block
                    ...
                    <div className={`${style.winnerSectionInner} silverBlock`}>
                      <div className={style.leftBlock}>
                        <img src='https://drfsb8fjssbd3.cloudfront.net/images/silver-winner.png' alt='Silver Winner' className={style.winnerSectionImg} />
                        <p>
                          Mattel Playtown
              ...
              <div className={`col-md-12 p-0 ${style.awardWinnersCol}`}>
                <div className={style.winnersOuterSection}>
                  <div className={style.categoryBadgeSection}>
                    <img src='https://drfsb8fjssbd3.cloudfront.net/images/Best_for_Older_Kids.png' alt='Awards Category' className={style.winnerSectionImg} />
              ...
              <div className={`col-md-12 p-0 ${style.awardWinnersCol}`}>
                <div className={style.winnersOuterSection}>
                  <div className={style.categoryBadgeSection}>
                    <img src='https://drfsb8fjssbd3.cloudfront.net/images/Best_for_Water_Fun.png' alt='Awards Category' className={style.winnerSectionImg} />
              ...
              <div className={`col-md-12 p-0 ${style.awardWinnersCol}`}>
                <div className={style.winnersOuterSection}>
                  <div className={style.categoryBadgeSection}>
                    <img src='https://drfsb8fjssbd3.cloudfront.net/images/Best_Birthday_Venue.png' alt='Awards Category' className={style.winnerSectionImg} />
