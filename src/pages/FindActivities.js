          ...
          <div className="container py-4">
            ...
            <div className="collapse" id="collapseExample">
             <div className="container">
              <div className={`row mt-2 p-2  rounded d-flex ${style1.collapserow}`}>
                <div className="col-lg-3 md-6">
                  <div className={style1.collapsediv1}>
                  <span>AgeRange*</span>
                  <select className={`form ${style1.selectbox} text-secondary`} aria-label="Default select example">
...
<div className="form-check">
  ...
  <label className="form-check-label text-secondary" for="flexCheckChecked">
    Courses
  </label>
</div>
<div className="form-check">
