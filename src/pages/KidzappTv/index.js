                  ...
                  <>
                    <Col>
                      <Card key={item.id} xs={12} md={4} className={`mx-4 my-2 ${style.cards}`} >
                        {/* <video src={item.video} autoPlay={true} /> */}
                        <video src='https://images.kidzapp.com/media/kidzapp_tv/videos/None_1c0742c8-ac24-43af-b108-5638d989089b.mp4' autoPlay={true} height='500px' width='500px' ></video>
