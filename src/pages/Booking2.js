                        ...
                        <div className="accordion-item">
                          ...
                          >
                            <div className="accordion-body">
                              Spend the day at a temperature controlled indoor
                              aqua park, complete with eight slide beams,
                              waterfall buckets, forest and more for your little
                              splashers. Your boys and girls are sure to love
                              it, and it's a fantastic spot for you and your
                              kiddos to play and stay cool all year round.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          ...
                          >
                            <div className="accordion-body">
                              <p>
                                {" "}
                                The entry ticket allows you access for up to 2.5
                                hours max.
                              </p>
                              <p>
                                {" "}
                                Kids under 5 need to be accompanied by an adult.
                              </p>
                              <p>
                                {" "}
                                This offer is notimport valid on public
                                holidays.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="col-lg-6 col-sm-12">
                      <div className={style.rightsection}>
                            ...
                            <div className="row mt-4">
                              <div className="col-lg-12">
                                <div className={style.payApp}>
                                  <p className="m-0">
                                    <b>Pay through App:</b> Convenient payment
                                    through Kidzapp
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="row mt-4">
                              <div className="col-12">
                                  ...
                                  <div className="col-lg-12  mb-3">
                                    <div className={style.pWrap}>
                                      ...
                                      <div className={`  ${style.pInput}`}>
                                        <input
                                          type="button"
                                          className={style.decrement_btn}
                                          value="-"
                                          onClick={() => dispatch(decrement())}
                                          id="decrement-btn5114"
                                        />
                                        <input
                                          type="text"
                                          name="adPrice1"
                                        ...
                                        <input
                                          type="button"
                                          className={style.increment_btn}
                                          value="+"
                                          onClick={() => dispatch(increment())}
                                          id="increment-btn5114"
                                        />
                                      </div>
                                      <div className={`  ${style.pName}`}>
                                        <p className={` m-0 ${style.ptext}`}>
                                ...
                                <div className="row mt-4">
                                  <div className="col-lg-12">
                                    <div
                                      className={`${style.payApp} ${style.payApp1}`}
                                    >
                                      <p className={` m-0 ${style.ptext}`}>
                        ...
                        <div className="row mt-4">
                          <div className="col-lg-12">
                            <div
                              className={`${style.payApp} ${style.payApp1} ${style.payApp2}`}
                            >
                              <p className={` m-0 ${style.ptext} `}>
                                <b>Total Price:</b>
                              </p>
                        ...
                        <div className="row mt-4">
                          <div className="col-12">
                            <div className="form-check">
                              ...
                              <p>
                                - This offer is not valid on public holidays
                              </p>
                              <p>
                                - Additional adult is charged at AED 50 per
                                person
                              </p>
                              <p>
                                - Pre-booking is required. Call venue ahead to
